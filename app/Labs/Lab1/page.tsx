...
export default function Lab1() {
  return (
    <div id="wd-lab1">
      <h1>Siggy Nazimowitz, Section 04</h1>
      <h2>Lab 1</h2>
      <h3>HTML Examples</h3>
...
<div id="wd-lists">
  ...
  How to make pancakes:
    ...
    <ol id="wd-your-favorite-recipe">
      <li>Heat a frying pan over medium heat, and add enough
        water to cover the bottom of the frying pan.</li>
      <li>Place hot dogs in frying pan and allow them to
        cook until the water is evaporated. Roll them around
        a little while they cook.</li>
      <li>Once all the water evaporates, add a slice of butter
        and melt it in the pan, cooking the hot dogs until
        they brown.</li>
      <li>Serve and enjoy!</li>
      </ol>
...
<a href="https://github.com/nazime1/CS5610-lab1" id="wd-github">Click here</a>
